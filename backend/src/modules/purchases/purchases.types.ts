...
export const PURCHASE_RETURN_SETTLEMENT_TYPES = ["pending", "partial", "settled"] as const;
...
export type PurchaseReturnSettlementType = (typeof PURCHASE_RETURN_SETTLEMENT_TYPES)[number];
