...
const getValidatedQuery = <T>(request: Request, response: Response) =>
  (response.locals.validatedQuery ?? request.query) as T;

export class ReportsController {
  public getOverview = async (request: Request, response: Response) => {
    const data = await reportsService.getOverview(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public listExports = async (request: Request, response: Response) => {
    const data = await reportsService.listExports(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getSalesSummary = async (request: Request, response: Response) => {
    const data = await reportsService.getSalesSummary(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getSalesDetailed = async (request: Request, response: Response) => {
    const data = await reportsService.getSalesDetailed(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getSalesTopCustomers = async (request: Request, response: Response) => {
    const data = await reportsService.getSalesTopCustomers(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getSalesTopProducts = async (request: Request, response: Response) => {
    const data = await reportsService.getSalesTopProducts(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getPurchasesSummary = async (request: Request, response: Response) => {
    const data = await reportsService.getPurchasesSummary(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getPurchasesDetailed = async (request: Request, response: Response) => {
    const data = await reportsService.getPurchasesDetailed(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getCustomersLedger = async (request: Request, response: Response) => {
    const data = await reportsService.getCustomersLedger(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getCustomersOutstanding = async (request: Request, response: Response) => {
    const data = await reportsService.getCustomersOutstanding(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getCustomersAging = async (request: Request, response: Response) => {
    const data = await reportsService.getCustomersAging(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getSuppliersLedger = async (request: Request, response: Response) => {
    const data = await reportsService.getSuppliersLedger(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getSuppliersOutstanding = async (request: Request, response: Response) => {
    const data = await reportsService.getSuppliersOutstanding(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getSuppliersAging = async (request: Request, response: Response) => {
    const data = await reportsService.getSuppliersAging(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getInventoryCurrentStock = async (request: Request, response: Response) => {
    const data = await reportsService.getInventoryCurrentStock(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getInventoryValuation = async (request: Request, response: Response) => {
    const data = await reportsService.getInventoryValuation(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getInventoryExpiry = async (request: Request, response: Response) => {
    const data = await reportsService.getInventoryExpiry(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getInventoryMovement = async (request: Request, response: Response) => {
    const data = await reportsService.getInventoryMovement(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getInventoryLowStock = async (request: Request, response: Response) => {
    const data = await reportsService.getInventoryLowStock(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getExpenseCategoryWise = async (request: Request, response: Response) => {
    const data = await reportsService.getExpenseCategoryWise(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getExpenseMonthly = async (request: Request, response: Response) => {
    const data = await reportsService.getExpenseMonthly(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getExpensePaymentMode = async (request: Request, response: Response) => {
    const data = await reportsService.getExpensePaymentMode(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getIncomeSummary = async (request: Request, response: Response) => {
    const data = await reportsService.getIncomeSummary(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getIncomeMonthly = async (request: Request, response: Response) => {
    const data = await reportsService.getIncomeMonthly(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getPayrollMonthly = async (request: Request, response: Response) => {
    const data = await reportsService.getPayrollMonthly(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getPayrollEmployee = async (request: Request, response: Response) => {
    const data = await reportsService.getPayrollEmployee(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getPayrollDepartment = async (request: Request, response: Response) => {
    const data = await reportsService.getPayrollDepartment(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getGstSummary = async (request: Request, response: Response) => {
    const data = await reportsService.getGstSummary(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getGstHsn = async (request: Request, response: Response) => {
    const data = await reportsService.getGstHsn(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getTrialBalance = async (request: Request, response: Response) => {
    const data = await reportsService.getTrialBalance(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getProfitLoss = async (request: Request, response: Response) => {
    const data = await reportsService.getProfitLoss(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getBalanceSheet = async (request: Request, response: Response) => {
    const data = await reportsService.getBalanceSheet(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getCashBook = async (request: Request, response: Response) => {
    const data = await reportsService.getCashBook(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public getBankBook = async (request: Request, response: Response) => {
    const data = await reportsService.getBankBook(getActor(request), getValidatedQuery(request, response), getContext(request));
  ...
  public exportReport = async (request: Request, response: Response) => {
    const file = await reportsService.exportReport(getActor(request), getValidatedQuery(request, response), getContext(request));
